...
namespace MDM
{
    public class WebDownloadClient : INotifyPropertyChanged
    {
        ...
        public void CheckUrl()
        {
            try
            {
                ...
                using (WebResponse response = webRequest.GetResponse())
                {
                    ...
                    if (this.FileSize <= 0)
                    {
                        System.Windows.MessageBox.Show("The requested file does not exist!", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
                        this.HasError = true;
                    }
                }
            }
            ...
            {
                System.Windows.MessageBox.Show("There was an error while getting the file information. Please make sure the URL is accessible.",
        ...
        private void CalculateAverageProgress()
        {
